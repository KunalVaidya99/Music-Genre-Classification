...
def download_image():
  ...
  downloader.download(filename + " Spotify Player", limit=1,  output_dir='/', adult_filter_off=True, force_replace=False, timeout=60)
  return filename
...
if file is None:
  ...
  st.image(filename +" Spotify Player" + "/Image_1.jpg",use_column_width=True)
